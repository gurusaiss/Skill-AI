  ...
  if (phase === 'quiz' && data) return (
    <QuizPhase
      ...
      onSubmit={async result => {
        ...
        console.log('[Session] Submitting session to backend...', {
          userId,
          day: Number(day),
        ...
        try {
          ...
          console.log('[Session] ✅ Submission successful!', submissionResult);
          
          // Store next day info for navigation
          result.nextDay = submissionResult?.nextDay || null;
        } catch (error) {
          console.error('[Session] ❌ Failed to submit session:', error);
